...
date: "2026-07-07"
description: "Concepts can be linearly encoded in activations and still be impossible to decode with a linear map. Why probes and sparse autoencoders fail on novel combinations of concepts, and what compressed sensing says to do instead."
